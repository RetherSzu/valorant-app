...
function SvgBundle({ color = "#000000", width = 24, height = 24 }: SvgProps) {
    return (
        <Svg
            width={width}
            height={height}
        ...
        >
            <Path
                d="M12 13.3c-.13 0-.26-.03-.38-.1L2.79 8.09a.752.752 0 01-.27-1.03.75.75 0 011.03-.27L12 11.68l8.4-4.86a.76.76 0 011.03.27c.21.36.08.82-.27 1.03l-8.77 5.08a.94.94 0 01-.39.1z"
                fill={color}
            />
            <Path
            ...
            />
            <Path
                d="M17 13.99c-.41 0-.75-.34-.75-.75v-3.22L7.13 4.76a.742.742 0 01-.27-1.02.74.74 0 011.02-.27l9.49 5.48c.23.13.38.38.38.65v3.66c0 .39-.34.73-.75.73z"
                fill={color}
            />
        </Svg>
    )

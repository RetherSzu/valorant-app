...
function SvgDayliShop({ color = "#ffffff", width = 24, height = 24 }: SvgProps) {
    return (
        <Svg
            width={width}
            height={height}
        ...
        >
            ...
            />
            <Path
                d="M16.5 8.63c-.41 0-.75-.34-.75-.75V6.5c0-1.05-.45-2.07-1.23-2.78a3.723 3.723 0 00-2.89-.95c-1.8.17-3.38 2.01-3.38 3.93v.97c0 .41-.34.75-.75.75s-.75-.34-.75-.75v-.98c0-2.69 2.17-5.17 4.74-5.42 1.5-.14 2.94.33 4.04 1.34a5.27 5.27 0 011.72 3.89v1.38c0 .41-.34.75-.75.75z"
                fill={color}
            />
        </Svg>
    )
